...
export default function AncLayout({ children }: { children: ReactNode }) {
  ...
  if (!isVerified) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-white dark:bg-zinc-950 bg-repeat bg-[url(&quot;data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'%3e%3cg fill='none' stroke='%23d4d4d8' stroke-width='0.5'%3e%3cpath d='M20 0 V 40 M0 20 H 40'/%3e%3c/g%3e%3c/svg%3e&quot;)] dark:bg-[url(&quot;data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'%3e%3cg fill='none' stroke='%2327272a' stroke-width='0.5'%3e%3cpath d='M20 0 V 40 M0 20 H 40'/%3e%3c/g%3e%3c/svg%3e&quot;)]">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-zinc-950 bg-repeat bg-[url(&quot;data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'%3e%3cg fill='none' stroke='%23d4d4d8' stroke-width='0.5'%3e%3cpath d='M20 0 V 40 M0 20 H 40'/%3e%3c/g%3e%3c/svg%3e&quot;)] dark:bg-[url(&quot;data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 40 40'%3e%3cg fill='none' stroke='%2327272a' stroke-width='0.5'%3e%3cpath d='M20 0 V 40 M0 20 H 40'/%3e%3c/g%3e%3c/svg%3e&quot;)]">
        {!isLoginPage && (
