    ...
    return (
        <div className="space-y-8 max-w-[1600px] mx-auto pb-24 lg:pb-12 px-4 md:px-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <Card className="lg:col-span-8 border-none ring-1 ring-border shadow-none overflow-hidden bg-card rounded-[2.5rem] flex flex-col min-h-[600px]">
                    ...
                    <CardContent className="p-0 flex-1">
                        ...
                        {filteredItems.total > displayLimit && (
                            <div className="p-8 border-t bg-primary/[0.02] flex justify-center">
                                <Button variant="secondary" onClick={() => setDisplayLimit(prev => prev + 15)} className="font-black uppercase tracking-widest text-[10px] gap-2 h-12 px-10 rounded-2xl shadow-sm">View More Records ({filteredItems.total - displayLimit} remaining)</Button>
                            </div>
                        )}
                    </CardContent>
                </Card>

                <Card className="lg:col-span-4 border-none ring-1 ring-border shadow-none overflow-hidden bg-card rounded-[2.5rem] flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto p-8 space-y-6">
                        {facilityStats.slice(0, 10).map((fac, i) => (
