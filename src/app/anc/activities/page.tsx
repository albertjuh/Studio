  ...
  const activities = [
    {
      ...
      description: "Capture new participants.",
      icon: UserPlus,
      href: "/anc/register",
    ...
    },
    {
      ...
      description: "Verified demographics.",
      icon: Database,
      href: "/anc/dashboard",
      color: "text-cyan-600",
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3">
            {filteredEssential.map((activity) => (
                <Link key={activity.href} href={activity.href} className="group active:scale-95 transition-all">
                    <div className={cn(
                        "relative flex flex-col items-center justify-center p-4 transition-all rounded-xl h-[140px] overflow-hidden border bg-white dark:bg-card shadow-sm hover:ring-2 hover:ring-primary/20"
                    )}>
                        <div className={cn("absolute -top-6 -right-6 w-20 h-20 blur-3xl opacity-20", activity.bgColor)} />
                        
                        <div className={cn(
                            "relative p-2.5 rounded-lg bg-slate-50 dark:bg-slate-900 group-hover:bg-primary group-hover:text-white transition-colors mb-3",
                            activity.color
                        )}>
                        ...
                        <div className="text-center space-y-1 relative z-10">
                            ...
                            <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest leading-none opacity-80">
      ...
      <div className="space-y-4 pt-2">
        <div className="flex flex-col items-center">
            <Button 
                ...
                variant="ghost"
                size="sm"
                className="h-8 px-6 rounded-lg font-black uppercase tracking-widest text-[8px] gap-2 hover:bg-primary/5 border border-dashed border-primary/20"
            >
                        ...
                        <Link key={activity.href} href={activity.href} className="group active:scale-95 transition-all">
                            <div className="p-3 rounded-xl border bg-white dark:bg-card shadow-sm hover:ring-2 hover:ring-primary/20 transition-all">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-[7px] font-black text-primary uppercase tracking-widest mb-0.5">{activity.category}</div>
                                        <h3 className="text-xs font-black tracking-tight leading-none">{activity.title}</h3>
                                    </div>
                                </div>
                            </div>
                        </Link>
