...
export default function VacuumBagTraceabilityPage({ params, searchParams }: { params: {}; searchParams: {} }) {
  return (
    <div className="container mx-auto py-6">
      <h2 className="text-3xl font-bold tracking-tight text-foreground mb-6">Vacuum Bag Traceability</h2>
