...
import { ArrowRight, Factory, Bike, ClipboardCheck } from 'lucide-react';
    ...
    <div className="flex items-center justify-center min-h-screen bg-background">
      <div className="w-full max-w-6xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link href="/coastal-insights/login">
          ...
          <Link href="/anc/login">
            <Card className="hover:border-primary transition-colors h-full flex flex-col">
              <CardHeader>
                ...
                <CardDescription>
                  A platform for managing patient data for an Antenatal Care cohort study.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <p className="text-sm text-muted-foreground">
                  Register new participants, track visits, and monitor study progress.
                </p>
              </CardContent>
              <div className="p-6 pt-0 text-primary font-semibold flex items-center">
                Open Project <ArrowRight className="ml-2 h-4 w-4" />
